...
_start:
	...
	mov	r0,#0 @starting at 0 to increment to 15
...
loop:
	...
	add r0,r0,#1	@ incrementing r0 to print the string
	cmp r0,#15	@ making sure it isn't equal 15 yet
	ble loop	@ if its less than 15 continue to print
	@==========================================
